...
This directory contains all reports for **Week 2 Practical Assignments** of the SOC Lab.

---

## 📌 Naming Convention

All practical assignments are denoted using the prefix:
...
- PA4 → Practical Assignment 4  
- PA5 → Practical Assignment 5  
